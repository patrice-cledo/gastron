...
exports.generateCanonicalKey = exports.parseIngredientLine = exports.extractModifiers = exports.normalizeUnit = exports.getCanonicalName = exports.normalizeToCanonicalKey = void 0;
/**
 * Normalize a string to a canonical key for deduplication
 */
function normalizeToCanonicalKey(text) {
...
exports.normalizeToCanonicalKey = normalizeToCanonicalKey;
/**
...
function parseIngredientLine(rawText) {
    ...
    if (!quantity && !unit)
        confidence = 0.5; // unclear quantity
    if (name.length < 2)
        confidence = 0.3; // very short name
    if (optional)
        confidence = 0.6; // optional items less certain
    return {
        name: canonicalName,
        quantity,
        unit,
 ...
 */
function generateCanonicalKey(parsed) {
    if (!parsed) {
...
exports.generateCanonicalKey = generateCanonicalKey;
//# sourceMappingURL=ingredientNormalizer.js.map